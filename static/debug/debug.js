...
const debug = {
  ...
  evtMoniter() {
    if (EventTarget) {
      var original_addEventListener = EventTarget.prototype.addEventListener, self = this
  ...
  /*
	...
	*/
  saveError(error) {
    var newError, _error = Object.assign({}, errorData.errorMessage, {
  ...
  proxyWindowError() {
    var self = this, f_error = window.onerror
    if (isPro) {
