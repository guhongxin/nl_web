    ...
    >
      <div class="dialog-body">
        <div class="vipCardDetails-frist">
          ...
          <vip-card-style 
            :vipCardData="vipCardData.vipCardData" 
            @changeSelect="changeSelecter"
            :isDisabled="isDisabled"></vip-card-style>
          ...
          <div class="vipCard-infor">
            ...
            <el-row :gutter="5" style="margin-bottom: 20px;">
              ...
              <el-col :span="12">
                <label>失效时间:
                  <!-- <span v-if="vipCardData.type===2">{{common.customFormat(vipCardDetailsData.over_date,'yyyy-MM-dd')}}</span>
            ...
            <el-row :gutter="5" style="margin-bottom: 20px;">
              ...
              <el-col :span="12">
                <label  v-if="vipCardData.type===1">赠次:<span>{{vipCardDetailsData.give_day?vipCardDetailsData.give_day:0}}（次）</span></label>
        ...
        <div class="vipCardDetails-two">
          <el-tabs type="border-card" @tab-click="borderCardBtn">
            <el-tab-pane label="卡主信息" >
              ...
              <div class="cardMasterInfor">
                ...
                <p>
                  手机:<span style="margin-left:5px;">{{vipCardDetailsData.customer?vipCardDetailsData.customer.phone:''}}</span>
                </p>
                <p>
            ...
            <el-tab-pane label="签到记录" >
              <el-table
                ...
                >
                  <template slot-scope="scope">
                    <span style="margin-left: 10px">{{scope.row.in_date? scope.row.in_date.split(' ')[1]: '-'}}</span>
                  </template>
                </el-table-column>
                <el-table-column
                  prop=""
                ...
                >
                   <template slot-scope="scope">
                    <span style="margin-left: 10px">{{scope.row.out_date? scope.row.out_date.split(' ')[1]: '-'}}</span>
                  </template>
                </el-table-column>
                <el-table-column
                  label="姓名"
            ...
            <el-tab-pane label="停卡记录" v-if="vipCardData.vipCardData?vipCardData.vipCardData.type===1:''">
                <el-table
                :data="stopCardRecord"
                border
                stripe
            ...
            <el-tab-pane label="扣次记录" v-if="vipCardData.vipCardData?vipCardData.vipCardData.type===2:''">
              <el-table
            ...
            <el-tab-pane label="续卡记录">
              <el-table
                ...
                <template v-if="vipCardData.vipCardData?vipCardData.vipCardData.type===1:''">
...
import { vipCardDetails, checkInRecord2, stopCardRecord, transferCardsRecord, deducCardList, renewalCardList } from '@/api/vipcardGl'
...
export default {
  ...
  data() {
    ...
    //   vipCardData: {},
      ...
      renewalCardRecordCurrentPage: 0,
  ...
  methods: {
    ...
    deductCardRecordPageChange(value) {
      // 切换扣次记录页码
      this.deductCardRecordCurrentPage = value
      this.getdeductCardRecord()
    },
    renewalCardRecordPageChange(value) {
      // 切换续卡记录页码
      this.renewalCardRecordCurrentPage = value
    ...
    getVipDetail(id) {
      vipCardDetails(id).then(res => {
        ...
        let _vipCardDetailsData = {
          ...
          real_pay: _data.order.real_total_fee,
          give_day: _data.give_day,
          magcard_id: _data.magcard_id,
          employee: _data.employee,
          employee_name: _data.order.employee_name,
          ...
          seller: _data.order.sell ? _data.order.sell.name : _data.order.sell_name,
          status: _data.status,
          card_no: _data.card_no,
          cardRemark: _data.remark,
          has_date: _data.has_date,
          payment_method: _data.order.payment_method,
        }
        let _followUp = {}
    ...
    getdeductCardRecord() {
      ...
      deducCardList(obj.vip_id, obj).then(res => {
        let data = res.data
    ...
    getrenewalCardRecord() {
      ...
      renewalCardList(obj.vip_id, obj).then(res => {
        let data = res.data
    ...
    defaultPageCompent() {
      ...
      this.stopCardRecordPageSize = 10
      this.stopCardRecordCurrentPage = 1
      this.checkInRecordPageSize = 10
      this.transferRecordCurrentPage = 1
      this.transferCardPageSize = 10
    },
