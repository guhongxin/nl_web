<template>
  <div class="VipCardDetailDialog-box">
    <div class="vipCardDetails-frist">
      ...
      <div class="vipCard-infor">
        ...
        <el-row :gutter="5" style="margin-bottom: 20px;">
          ...
          <el-col :span="12">
            <label  v-if="vipCardData.type===2">赠次:<span>{{vipCardDetailsData.give_day?vipCardDetailsData.give_day:0}}（次）</span></label>
        ...
        <el-row :gutter="5" style="margin-bottom: 20px;">
          ...
          <el-col :span="12" v-if="vipCardDetailsData.gyms">
            <label>可使用分店:</label>
    ...
    <div class="vipCardDetails-two">
      <el-tabs type="border-card" @tab-click="borderCardBtn" style="overflow: hidden;">
        ...
        <el-tab-pane label="签到记录" v-if="cardType!==3">
          <el-table
            :data="tabData"
            border
            stripe
        ...
        <el-tab-pane label="停卡记录" v-if="cardType===1">
            <el-table
            :data="tabData"
            border
            stripe
        ...
        <el-tab-pane label="扣次记录" v-if="cardType===2">
          <el-table
            :data="tabData"
            border
            stripe
        ...
        <el-tab-pane label="续卡记录" v-if="cardType!==3">
          <el-table
            :data="tabData"
            border
            stripe
        ...
        <el-tab-pane label="充值记录" v-if="cardType===3">
          <el-table
            :data="tabData"
            border
            stripe
        ...
        <el-tab-pane label="消费记录" v-if="cardType===3">
            <el-table
              :data="tabData"
              border
              stripe
...
import { checkInRecord2, stopCardRecord, transferCardsRecord, deducCardList, renewalCardList, deducCardexpenseList } from '@/api/vipcardGl'
...
export default {
  ...
  data() {
    return {
      ...
      paginationShow: true,
      isDisabled: false,
      isMscard: this.vipCardData.master_id, // 是否是通卡
      cardID: this.vipCardData.id, // 卡id
      cardType: this.vipCardData.type // 卡类型
    }
  },
  methods: {
    ...
    getStopCardRecord() {
      ...
      obj.vip_id = this.vipCardDetailsData.id
      this.tabloading = true
