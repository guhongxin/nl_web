<template>
  <div class="box1">
    ...
    <div style="overflow:hidden" class="filter-container">
      ...
      <el-button class="derive" v-if="btnRoleList['7-3-3-1']"  @click="doExport('私教预约修改')" :loading="domnloading"><i class="el-icon-printer"></i> 导出</el-button>
...
export default {
  ...
  data() {
    let filterArr = actionValue.filter(v => {
      return v.type === 'private-appointment'
    })
    filterArr.forEach(v => {
      v.class = 'ctype'
