  ...
  <div>
    ...
    <el-table stripe 
      ...
      <el-table-column align="center" label="课程名称" prop="create_sort">
        <template slot-scope="scope">
          <span>{{scope.row.course_order_details[0]?scope.row.course_order_details[0].course_data?scope.row.course_order_details[0].course_data.name:'':''}}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="购买时间" prop="create_sort" width="180">
        <template slot-scope="scope">
          <span>{{scope.row.course_order_details[0]?scope.row.course_order_details[0].created_at:''}}</span>
        </template>
      </el-table-column>
