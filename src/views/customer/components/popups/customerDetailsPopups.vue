...
import cardList from '@/views/customer/components/popups/tabList/cardList'
import sportsRecord from '@/views/customer/components/popups/tabList/sportsRecord'
import testBodyReport from '@/views/customer/components/popups/tabList/testBodyReport'
import saleData from '@/views/customer/components/popups/tabList/saleData'
