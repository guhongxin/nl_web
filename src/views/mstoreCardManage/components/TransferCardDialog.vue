              ...
              <div style="background-color:#ffffff;height:685px;" class="vipCard-infor">
                ...
                <el-form :model="transferCardInforForm"
                  ...
                  <el-form-item label="实付金额" placeholder="请填写实付金额" label-width="100px" prop="real_pay">
                    <el-input v-model="transferCardInforForm.real_pay" type="number" placeholder="请输入金额"></el-input>
                  </el-form-item>
                  ...
                  <el-form-item label="支付方式" label-width="100px" prop="paymethod">
                    <el-select v-model="transferCardInforForm.paymethod"  placeholder="请选择支付方式">
            ...
            <el-col :span="14" >
               <div style="background-color:#ffffff;" class="vipCard-infor">
                  ...
                  <div class="skryxi-from">
                    <el-form :model="skryxiForm"  label-width="80px" class="demo-skryxiForm" ref="skryxiForm" :rules="rules2">
                      <el-form-item label="手机号码" prop="phone">
                        <el-input v-model="skryxiForm.phone" placeholder="请输入客户手机号码" :disabled="isSearchCoustomer"></el-input>
                ...
                <div class="skryxi-bottom">
                  ...
                  <el-button type="primary" @click="skryxiFormBtnOK" style="background-color: rgb(51, 51, 51);color:#ffffff;">确定</el-button>
                </div>
               </div>
            </el-col>
          </el-row>
...
import { vipCardDetails, getPhoneCustomers, transferVipCard } from '@/api/vipcardGl'
...
export default {
  ...
  methods: {
    ...
    skryxiFormBtnOK() {
      // 确认转卡
      // if (!this.imageUrl) {
      //   this.common.message('error', '请上传顾客头像!')
      //   return false
      // }
